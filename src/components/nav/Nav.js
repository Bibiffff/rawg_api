    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container">
                <Link className="navbar-brand" to="/">RAWG GAMEs</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="d-flex p-2" role="search" onChange={handleFormChange} onSubmit={handleFormSubmit}>
                    ...
                    </form>
                    {
                        user === undefined ?
                            ...
                            :
                            <div className="">
                                <Link className="text-decoration-underline" to="/profile">{user.username}</Link>
                            </div>
                    }
                </div>
            </div>
